...
public class egglogger implements Listener {

	public final static HashMap<String, String> idNames = new HashMap<String, String>();
	...
	public void throwEggLog(PlayerInteractEvent e) {
		...
		if(e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
			if(e.getPlayer().getItemInHand().getType() == Material.MONSTER_EGG || e.getPlayer().getItemInHand().getType() == Material.MONSTER_EGGS) {
				...
				try {
					FileWriter fw = new FileWriter(fileManager.getDir() + File.separator + "spawnEgg_activity.log", true);
